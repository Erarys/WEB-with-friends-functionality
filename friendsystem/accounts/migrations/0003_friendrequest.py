...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0002_user_friends_user_is_verified_user_role'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Ожидание'), ('accepted', 'Принят'), ('declined', 'Отклонён')], default='pending', max_length=10)),
